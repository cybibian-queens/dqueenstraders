...
export default class RunPanelStore {
    ...
    showRealAccountDialog = () => {
        ...
        this.dialog_options = {
            title: localize("DQueens Traders isn't quite ready for real accounts"),
            message: localize('Please switch to your demo account to run your DQueens Traders.'),
        };
        this.is_dialog_open = true;
    };
    ...
    showIncompatibleStrategyDialog = () => {
        ...
        this.dialog_options = {
            ...
            message: localize('This strategy is currently not compatible with DQueens Traders.'),
        };
        this.is_dialog_open = true;
    };
