...
export default class AppStore {
    ...
    getErrorForNonEuClients = () => ({
        ...
        title: localize('DQueens Traders is unavailable for this account'),
    ...
    getErrorForEuClients = (is_logged_in = false, country: string | undefined = undefined) => {
        return {
            text: ' ',
            title: is_logged_in
                ? localize(`DQueens Traders is not available for ${country || 'EU'} clients`)
                : localize(`DQueens Traders is unavailable in ${country || 'the EU'}`),
