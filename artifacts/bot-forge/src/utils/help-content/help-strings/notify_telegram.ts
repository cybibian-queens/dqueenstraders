...
export default {
    text: () => [
        ...
        localize(
            '4. Come back to DQueens Traders and add the Notify Telegram block to the workspace. Paste the Telegram API token and chat ID into the block fields accordingly.'
        ),
    ],
};
