...
export const OSCARS_GRIND = (): TDescriptionItem[] => [
    {
        type: 'subtitle',
        content: [localize('Exploring the Oscar’s Grind strategy in DQueens Traders')],
        expanded: true,
    ...
    {
        type: 'text',
        content: [localize('These are the trade parameters used for Oscar’s Grind strategy in DQueens Traders.')],
    },
    {
        type: 'text',
        content: [
