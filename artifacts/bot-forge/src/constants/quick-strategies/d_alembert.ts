...
export const D_ALEMBERT = (): TDescriptionItem[] => [
    {
        type: 'subtitle',
        content: [localize('Exploring the D’Alembert strategy in DQueens Traders')],
        expanded: true,
    ...
    {
        type: 'text',
        content: [localize('These are the trade parameters used for D’Alembert strategy in DQueens Traders.')],
    },
    {
        type: 'text',
    ...
    },
    {
        ...
        content: [
            ...
            localize(
                '4. If the second trade results in a loss, the DQueens Traders will automatically increase your stake for the next trade by 2 USD. DQueens Traders will continue to add 2 USD to the previous round’s stake after every losing trade. See A2.'
            ),
            localize(
