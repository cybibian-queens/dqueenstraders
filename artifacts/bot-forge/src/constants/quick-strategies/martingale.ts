...
export const MARTINGALE = (): TDescriptionItem[] => [
    {
        type: 'subtitle',
        content: [localize('Exploring the Martingale strategy in DQueens Traders')],
        expanded: true,
    ...
    {
        type: 'text',
        content: [localize('These are the trade parameters used in DQueens Traders with Martingale strategy.')],
    },
    {
        type: 'text',
        content: [
    ...
    },
    {
        ...
        content: [
            ...
            localize(
                '3. If the first trade ends in a loss, DQueens Traders will automatically double your stake for the next trade to 2 USD. DQueens Traders will continue to double the stake after every losing trade.'
            ),
            localize(
    ...
    },
    {
        ...
        content: [
            localize(
                "The idea is that successful trades may recoup previous losses. However, it is crucial to exercise caution as the risk can quickly increase with this strategy. With DQueens Traders, you can minimise your risk by setting a maximum stake. This is an optional risk management feature. Let’s say a maximum stake of 3 USD. If your stake for the next trade is set to exceed 3 USD, your stake will reset to the initial stake of 1 USD. If you didn't set a maximum stake, it would have increased beyond 3 USD."
            ),
        ],
    },
    {
    ...
    },
    {
        ...
        content: [
            localize(
                "With DQueens Traders, traders can set the profit and loss thresholds to secure potential profits and limit potential losses. This means that the trading bot will automatically stop when either the profit or loss thresholds are reached. It's a form of risk management that can potentially enhance returns. For example, if a trader sets the profit threshold at 100 USD and the strategy exceeds 100 USD of profit from all trades, then the bot will stop running."
            ),
        ],
    },
    {
