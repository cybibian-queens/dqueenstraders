...
export const REVERSE_MARTINGALE = (): TDescriptionItem[] => [
    {
        type: 'subtitle',
        content: [localize('Exploring the Reverse Martingale strategy in DQueens Traders')],
        expanded: true,
    ...
    {
        type: 'text',
        content: [localize('These are the trade parameters used in DQueens Traders with Reverse Martingale strategy.')],
    },
    {
        type: 'text',
        content: [
    ...
    },
    {
        ...
        content: [
            ...
            localize(
                '3. If the first trade is a successful trade, DQueens Traders will automatically double your stake for the next trade to 2 USD. DQueens Traders will continue to double the stake after every successful trade.'
            ),
            localize(
