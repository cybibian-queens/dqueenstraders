...
export const REVERSE_D_ALEMBERT = (): TDescriptionItem[] => [
    {
        type: 'subtitle',
        content: [localize('Exploring the Reverse D’Alembert strategy in DQueens Traders')],
        expanded: true,
    ...
    {
        type: 'text',
        content: [localize('These are the trade parameters used in DQueens Traders with Reverse D’Alembert strategy.')],
    },
    {
        type: 'text',
    ...
    },
    {
        ...
        content: [
            ...
            localize(
                '3. For trades that result in a profit, the stake for the next trade will be increased by 2 USD. DQueens Traders will continue to add 2 USD for every successful trade. See A1.'
            ),
            localize(
    ...
    },
    {
        ...
        content: [
            localize(
                'With DQueens Traders, traders can set the profit and loss thresholds to secure potential profits and limit potential losses. This means that the trading bot will automatically stop when either the profit or loss threshold is reached. This is a form of risk management that can potentially boost successful trades whilst limiting the impact of loss. For example, if a trader sets the profit threshold at 100 USD and the strategy exceeds 100 USD of profit from all trades, then the bot will stop running.'
            ),
        ],
    },
    {
