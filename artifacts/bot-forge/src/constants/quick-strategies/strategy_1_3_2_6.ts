...
export const STRATEGY_1_3_2_6 = (): TDescriptionItem[] => [
    {
        type: 'subtitle',
        content: [localize('Exploring the 1-3-2-6 strategy in DQueens Traders')],
        expanded: true,
    ...
    {
        type: 'text',
        content: [localize('These are the trade parameters used in DQueens Traders with 1-3-2-6 strategy.')],
    },
    {
        type: 'text',
        content: [
