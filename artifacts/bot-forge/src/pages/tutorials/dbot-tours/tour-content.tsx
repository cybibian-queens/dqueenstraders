...
export const DBOT_ONBOARDING_MOBILE: TMobileTourConfig[] = [
    {
        header: <Localize i18n_default_text='Welcome to DQueens Traders' />,
        content: [
            <span key='get-started-on-deriv-bot-wrapper'>
                <Localize
                    key='get-started-on-deriv-bot'
                    i18n_default_text='Let’s take a quick tour to discover how DQueens Traders works. Press <0>Start</0> to begin.'
                    components={[<strong key={0} />]}
                />
            </span>,
        ],
...
export const getTourDialogInfo = (is_mobile: boolean) => {
    return is_mobile ? (
        <Localize
            ...
            i18n_default_text='Here’s a quick guide on how to use DQueens Traders on the go.'
        />
    ) : (
...
export const onboarding_tour_header = (
    <Localize key='onboarding-tour-header' i18n_default_text='Welcome to DQueens Traders' />
);
