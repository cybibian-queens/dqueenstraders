...
export const user_guide_content = (): TUserGuideContent[] => [
    {
        ...
        type: 'Tour',
        subtype: 'OnBoard',
        content: localize('Get started on DQueens Traders'),
...
export const guide_content = (): TGuideContent[] => [
    {
        id: 1,
        type: 'DBotVideo',
        content: localize('An introduction to DQueens Traders'),
    ...
    },
    {
        id: 2,
        type: 'DBotVideo',
        content: localize('How to build a basic trading bot with DQueens Traders'),
    ...
    },
    {
        id: 3,
        type: 'DBotVideo',
        content: localize('How to use Martingale strategy on DQueens Traders'),
    ...
    },
    {
        id: 4,
        type: 'DBotVideo',
        content: localize('Introducing Accumulator Options on DQueens Traders: Available for automated trading'),
...
export const faq_content = (): TFaqContent[] => [
    {
        title: localize('What is DQueens Traders?'),
        description: [
            {
                type: 'text',
                content: localize(
                    "DQueens Traders is a web-based strategy builder for trading digital options. It’s a platform where you can build your own automated trading bot using drag-and-drop 'blocks'."
                ),
            },
        ],
        search_id: 'faq-0',
    ...
    {
        title: localize('Do you offer pre-built trading bots on DQueens Traders?'),
        description: [
            {
                type: 'text',
                content: localize(
        ...
        description: [
            {
                type: 'text',
                content: localize(
                    "A quick strategy is a ready-made strategy that you can use in DQueens Traders. There are 3 quick strategies you can choose from: Martingale, D'Alembert, and Oscar's Grind."
                ),
            },
            {
                type: 'text',
    ...
    {
        title: localize('How do I import my own trading bot into DQueens Traders?'),
        description: [
            {
                type: 'text',
                content: localize(
    ...
    {
        title: localize('How do I control my losses with DQueens Traders?'),
        description: [
            {
                type: 'text',
                content: localize(
                    'There are several ways to control your losses with DQueens Traders. Here’s a simple example of how you can implement loss control in your strategy:'
                ),
            },
            {
                type: 'image',
    ...
    {
        title: localize('Can I run DQueens Traders on multiple tabs in my web browser?'),
        description: [
            {
                type: 'text',
                content: localize(
    ...
    {
        title: localize('Can I trade cryptocurrencies on DQueens Traders?'),
        description: [
            {
                type: 'text',
                content: localize("No, we don't offer cryptocurrencies on DQueens Traders."),
            },
        ],
        search_id: 'faq-12',
    },
        ...
        description: [
            {
                type: 'text',
                content: localize(
                    "No, we don't. However, you'll find quick strategies on DQueens Traders that'll help you build your own trading bot for free."
                ),
            },
        ],
        search_id: 'faq-13',
    ...
    {
        title: localize('In which countries is DQueens Traders available?'),
        description: [
            {
                type: 'text',
                content: localize(
    ...
    {
        title: localize('If I close my web browser, will DQueens Traders continue to run?'),
        description: [
            {
                type: 'text',
                content: localize('No, DQueens Traders will stop running when your web browser is closed.'),
            },
        ],
        search_id: 'faq-15',
    },
        ...
        description: [
            {
                type: 'text',
                content: localize(
                    "Three of the most commonly used strategies in automated trading are Martingale, D'Alembert, and Oscar's Grind — you can find them all ready-made and waiting for you in DQueens Traders."
                ),
            },
        ],
        search_id: 'faq-16',
        ...
        description: [
            {
                type: 'text',
                content: localize(
                    '<a href="https://www.youtube.com/watch?v=QdI5zCkO4Gk&t=203s" target="_blank">Watch this video</a> to learn how to build a trading bot on DQueens Traders. Also, <a href="https://deriv.com/academy/blog/posts/how-to-build-a-basic-trading-bot-with-dbot/" target="_blank">check out this blog post</a> on building a trading bot.'
                ),
            },
        ],
        search_id: 'faq-17',
...
export const quick_strategy_content = (): TQuickStrategyContent[] => [
    {
        ...
        content: [
            localize('Exploring the Martingale strategy in DQueens Traders'),
    ...
    },
    {
        ...
        content: [
            localize('Exploring the D’Alembert strategy in DQueens Traders'),
    ...
    },
    {
        ...
        content: [
            localize('Exploring the Oscar’s Grind strategy in DQueens Traders'),
    ...
    },
    {
        ...
        content: [
            localize('Exploring the Reverse Martingale strategy in DQueens Traders'),
    ...
    },
    {
        ...
        content: [
            localize('Exploring the Reverse D’Alembert strategy in DQueens Traders'),
    ...
    },
    {
        ...
        content: [localize('Exploring the 1-3-2-6 strategy in DQueens Traders'), localize('An example of 1-3-2-6 strategy')],
