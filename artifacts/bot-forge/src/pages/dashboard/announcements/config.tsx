...
export const ANNOUNCEMENTS: Record<string, TAnnouncement> = {
    ...
    MOVING_STRATEGIES_ANNOUNCE: {
        announcement: {
            ...
            main_title: localize('Moving strategies to DQueens Traders'),
            ...
            numbered_content: [
                {
                    id: 0,
                    text: localize('Download your strategy in XML format and import it to DQueens Traders.'),
                },
                {
                    id: 1,
            ...
            plain_text: [
                {
                    ...
                    text: (
                        <Localize
                            i18n_default_text='<0>Note</0>: Uploading complex strategies may take some time. Saving them from DQueens Traders ensures quicker access later. If you have questions, contact us via <1/>.'
    ...
    BLOCKLY_ANNOUNCE: {
        announcement: {
            ...
            title: (
                <Localize
                    i18n_default_text='We have updated our Blockly system in DQueens Traders from <0>version 3 to version 10</0>. This brings:'
                    components={[<strong key={0} />]}
                />
            ),
            numbered_content: [
    ...
    ACCUMULATOR_ANNOUNCE: {
        announcement: {
            ...
            main_title: localize('Accumulators now on DQueens Traders'),
    ...
    PWA_INSTALL_ANNOUNCE: {
        announcement: {
            ...
            main_title: localize('Install DQueens Traders as an App'),
            ...
            content: [
                {
                    id: 0,
                    text: localize(
                        'Install DQueens Traders directly on your device for faster access and better performance.'
                    ),
                },
                {
                    id: 1,
...
export const BOT_ANNOUNCEMENTS_LIST: TAnnouncementItem[] = [
    {
        id: 'PWA_INSTALL_ANNOUNCE',
        icon: IconAnnounce,
        title: localize('Install DQueens Traders as an App'),
        message: localize('Get faster access and better performance by installing DQueens Traders on your device.'),
    ...
    },
    {
        id: 'MOVING_STRATEGIES_ANNOUNCE',
        icon: IconAnnounce,
        title: localize('Moving strategies to DQueens Traders'),
    ...
    },
    {
        ...
        message: localize('We have updated our Blockly system in DQueens Traders from version 3 to version 10.'),
    ...
    },
    {
        id: 'ACCUMULATOR_ANNOUNCE',
        icon: IconAnnounce,
        title: localize('Accumulators is now on DQueens Traders'),
